...
## `annotation_dedup.py`
This module contains a one-time script to eliminate existing duplicate `PubtatorAnnotation` nodes from the database as generated by `initial_loading.py`. It can be run with `python3 annotation_dedup.py`.
