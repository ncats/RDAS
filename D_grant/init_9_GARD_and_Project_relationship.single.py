...
if __name__ == '__main__':
    ...
    min_id = 2066200 #1774252#1670052#1584253 #765554 #730494 #72401 #0
    max_id = 2875061
    step = 1
    batch_size = 100
    ...
    for start_id, end_id in id_ranges:
        ...
        query = f''' 
            ...
            a.ABSTRACT_TEXT 
            FROM rdas_db.grant_project p, rdas_db.grant_abstract a
            where (p.id BETWEEN {start_id} AND {end_id}) AND p.APPLICATION_ID=a.APPLICATION_ID and p.FY=a.YEAR
        '''  
        ...
        for row in rows:
            ...
            print(f'id_count = {id_count}, id = {id}, application_id = {application_id}')
