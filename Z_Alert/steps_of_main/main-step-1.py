...
LOOK_BACK_DAYS = 7
STEP_NAME = "Step 1: run_find_new_clinical_trial_and_publication_updates()"
...
def main() -> None:
    ...
    try:
        runner._run_step_with_timing(STEP_NAME, runner.run_find_new_clinical_trial_and_publication_updates)
